    ...
    <div>
      ...
      <div style={{ display: "flex", margin: "20px 0 0 0" }}>
        ...
        >
          ...
          />
          <div style={{marginTop:50}}><p>{bmi < 18.5
                    ? "偏瘦，可将管理目标调整为塑形，提升身体素质。"
                    : bmi < 24
                      ? "标准体重，进阶管理需注意提升代谢水平，可采取16:8饮食法，配合运动。"
                      : bmi < 28
                        ? "超重了，稍微努力一下就能拥有完美身材。加油！我们陪你一起努力！"
                        : "肥胖，首要任务是改善代谢功能，控制糖分和热量，健康变瘦。"}</p></div>
        </Card>
        
      </div>
      <div style={{width:300,display:"flex",justifyContent:"center",margin:"0 auto"}}>
          <p style={{color:'#848181', textAlign: 'center'}}> 
            注：BMI是目前诊断肥胖最广泛使用的方法和指标；
